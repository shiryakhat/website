...
* این توکن مثل LP توکن یونی‌سواپ قابل جابه‌جایی، وثیقه‌گذاری و استفاده در دیفای است و اجازه می‌دهد کسانی که کمتر از ۳۲ اتریوم دارند هم در ریوارد شبکه سهیم شوند.
...
* AVSها (Active Validation Service) سرویس‌هایی مثل بریج، دیسنترالایزد سکوئنسر و دیتا اویلبیلیتی هستند که ولیدیتورها می‌توانند نودشان را اجرا کنند و ریوارد بگیرند.
