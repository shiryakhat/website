...
description: "در قسمت ششم از فصل هفتم پادکست شیر یا خط با عنوان «هوش مصنوعی و بلاکچین: همگرایی فناوری‌ها»، شایان، امین، امیر و حمید از مسیر تحول یادگیری ماشین تا مدل‌های زبانی بزرگ (LLM)، تکنیک وایب کدینگ و بازسازی زنده‌ی وبسایت شیر یا خط با کلاد، عامل‌های هوشمند و اتوماسیون با N8N، و در نهایت تقاطع هوش مصنوعی و بلاکچین صحبت می‌کنند. این اپیزود مفاهیمی مانند پروتکل MCP، فریم‌ورک ElizaOS و ماژول کریپتوی آن، والت و ترنزکشن ایجنت‌ها، یلد فارمینگ، محیط اجرای امن TEE و اینتل SGX، رمزنگاری هومومورفیک کامل (Zama)، پایگاه داده‌ی برداری، RAG و نالج‌گراف را پوشش می‌دهد و نشان می‌دهد چطور کریپتو می‌تواند لایه‌ی اعتماد و انتقال سرمایه برای عامل‌های هوشمند خودمختار باشد. کلیدواژه‌ها: اتریوم، بلاکچین، قرارداد هوشمند، هوش مصنوعی، وایب کدینگ، AI Agent، ElizaOS، MCP، TEE، رمزنگاری هومومورفیک، دیفای، یلد فارمینگ، DAO، نالج‌گراف، RAG."
...
* کاربرد عامل‌های هوشمند در [مدیریت خزانه و عملیات مالی](https://shiryakhat.net/2020/07/defi-is-here-to-stay.html)
* [پروژه‌های EthGlobal AI](https://shiryakhat.net/2025/01/hackathons.html) و [نمونه‌های برگزیده از ایونت‌ها](https://shiryakhat.net/2025/02/devcon7.html)
* امنیت و رمزنگاری در هوش مصنوعی و بلاکچین (TEE و [Fully Homomorphic Encryption](https://shiryakhat.net/2025/08/privacy-blockchain-right-or-crime-tool.html))
