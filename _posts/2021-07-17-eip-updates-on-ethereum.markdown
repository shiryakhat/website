...
* ERC20 (یا EIP20) استاندارد توکن است و مشخص می‌کند یک توکن چه آپشن‌هایی مثل نام، سیمبول، تعداد ارقام اعشار، بالانس و ترنسفر باید داشته باشد تا ولت‌ها و قراردادهای دیگر بتوانند با آن کار کنند؛ ویتالیک یکی از نویسندگان آن بود و همین استاندارد راه را برای ICOها و توکن‌سازی باز کرد.
...
* استدلال می‌شود چون اتریوم نیاز به تغییرات سریع و زیاد (مثل مسیر اتریوم ۲) دارد و نمی‌تواند مثل بیت‌کوین سال‌ها منتظر بماند، نمی‌تواند کاملاً غیرمتمرکز باشد؛ ویتالیک تصمیم‌گیری را به تیمی از متخصصان واگذار کرد تا یک دوران گذار به سیستم غیرمتمرکزتر طی شود.
